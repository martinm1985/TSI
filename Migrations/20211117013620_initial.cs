        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TarjetaDebito = table.Column<bool>(type: "bit", nullable: false),
                    Cuenta = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdEntidadFinanciera = table.Column<int>(type: "int", nullable: false),
                    ...
                    NombreEnTarjeta = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EsCredito = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Video_Duracion = table.Column<decimal>(type: "decimal(18,2)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", "3732a745-26f4-4926-8e60-3f6cd0dd60a9", "Administrator", "ADMINISTRATOR" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "Name", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "Surname", "TwoFactorEnabled", "UserName", "isAdministrador" },
                values: new object[] { "1", 0, "fb937ece-7151-4f36-89ad-e8f5ace7d9cf", "creadoresuyadmin@gmail.com", false, false, null, "Creadores", "CREADORESUYADMIN@GMAIL.COM", "CREADORESUY", "AQAAAAEAACcQAAAAEI4q+Lmcyqm5/9UlRJgB7Szr24IFGe7gkx6l77XKsxGoGnejKPjebMI2ZdLYrGzpdA==", null, false, "5703e212-e339-4bf3-9781-935fdfa83758", "UY", false, "CreadoresUY", true });
